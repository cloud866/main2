public class Vector2D extends Vector {
    ...
    public double getScalarProduct(Vector2D vector2D) {  // take cords first and second vectors and search scaler product
    ...
    public double getAngle(Vector2D vector2D) {  // search cos angles between vectors
